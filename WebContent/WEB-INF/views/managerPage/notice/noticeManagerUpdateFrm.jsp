                                ...
                                <table class="table table-borader">
                                    <tr>
                                        <th colspan="2" style="background-color:#F1F1F1">
                                            ...
                                            <input type="text" style="width:400px;" name="noticeTitle" value="<%=n.getNoticeTitle() %>">
                                        </th>
                                    ...
                                    <tr>
                                        <th>내용</th>
                                        <td><textarea name="noticeContent" class="form-control" rows="3" cola="4"><%=n.getNoticeContent() %></textarea></td>
                                    </tr>
